...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
		...
		sass: {
            development: {
                files: {
                    'app/styles/style.css': 'app/scss/style.scss'
                },
                options: {
                    sourcemap: 'true'
                }
        ...
        watch: {
            styles: {
				files: ['app/scss/**/*.scss','app/less/**/*.less'],
                tasks: ['less','scss', 'copy:styles'],
                options: {
                    nospawn: true,
            ...
            livereload: {
                ...
                files: [
                    '<%= zcake.app %>/**/*.html',
                    '.tmp/styles/{,*/}*.css',
                    '<%= zcake.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
                ]
            }
        },
        ...
        filerev: {
            dist: {
                src: [
                    '<%= zcake.dist %>/scripts/{,*/}*.js',
                    '<%= zcake.dist %>/styles/{,*/}*.css',
                    '<%= zcake.dist %>/styles/fonts/*'
                ]
            }
        },
        htmlmin: {
